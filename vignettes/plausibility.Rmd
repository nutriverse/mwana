...
When working on a multiple-area data set, for instance districts, we can check the plausibility of all districts in the data set at once by using the argument `.by` as follows:
